...
grep -q "selected: 2  run: 1  skipped: 0  blocked: 1" "$tmpdir/plan-upstream.txt"
grep -q "RUN     case_summaries" "$tmpdir/plan-upstream.txt"
grep -q "BLOCK   weekly_support_insights" "$tmpdir/plan-upstream.txt"
...
grep -q "selected: 2  run: 1  skipped: 1  blocked: 0" "$tmpdir/plan-downstream.txt"
...
grep -q "selected: 1  run: 1  skipped: 0  blocked: 0" "$tmpdir/plan-force.txt"
...
grep -q "selected: 1  run: 1  skipped: 0  blocked: 0" "$tmpdir/build-case-force.txt"
