...
func runnableBaseFiles(projectName, runnerRoot, selectors string) []fileSpec {
	return []fileSpec{
		...
		{Path: "bin/fbt-demo-llm-runner", Content: runnerScript(runnerRoot, filepath.Join("examples", "runner_adapters", "demo_llm")), Executable: true},
		{Path: "bin/fbt-demo-agent-runner", Content: runnerScript(runnerRoot, filepath.Join("examples", "runner_adapters", "demo_agent")), Executable: true},
	}
}
...
func runnerScript(runnerRoot, relative string) string {
