...
<p align="center">
<a href="https://github.com/nyuta01/fbt/releases/tag/v0.2.1"><img alt="Release" src="https://img.shields.io/github/v/release/nyuta01/fbt?label=fbt"></a>
...
Install provider/agent adapters separately; see the [installation guide](apps/docs/src/content/docs/get-started/installation.mdx).
...
Start with the [usage guide](docs/usage-guide.md), [manual generation guide](apps/docs/src/content/docs/get-started/manual-generation.mdx), and [CLI reference](docs/cli-reference.md). Agent runtime instructions are in [skills/README.md](skills/README.md). The published docs site is [nyuta01.github.io/fbt](https://nyuta01.github.io/fbt/).
