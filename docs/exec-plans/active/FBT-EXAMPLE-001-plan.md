...
configuration, source evidence, output format assets, and eval gates.

## Decision

Add two production-shaped examples that plan without provider calls
...
`make practical-examples-smoke` to plan both examples in the default
