...
Add an optional out-of-core runner under `adapters/openai`. It speaks the fbt
...
Implemented `adapters/openai` with unit coverage against an `httptest` Responses
