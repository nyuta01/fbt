...
Add an optional out-of-core runner under `examples/runner_adapters/openai`. It speaks the fbt
...
Implemented `examples/runner_adapters/openai` with unit coverage against an `httptest` Responses
