...
runner/model metadata, approval state, and generating run IDs manually.
...
approval state, confidence, generating run, commit time, and materials where
available. Added CLI tests, knowledge-loop smoke coverage, and documentation.
