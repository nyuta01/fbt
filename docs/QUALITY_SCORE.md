...
| Go CLI Scaffold | 4 | CLI now exposes help/version plus parse, plan, state, and artifact inspection commands with tests and smoke coverage | Build, eval, review, diff, docs, and runner commands are still pending | `FBT-MVP-007` |
